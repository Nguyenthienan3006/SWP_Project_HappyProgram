 ...
 * @author dongx
 */
@WebServlet(name = "CvOfMentorServlet", urlPatterns = {"/CvOfMentorServlet"})
public class CvOfMentorServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(CvOfMentorServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
