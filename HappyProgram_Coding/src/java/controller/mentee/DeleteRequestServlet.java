 ...
 * @author An Nguyen
 */
@WebServlet(name = "DeleteRequestServlet", urlPatterns = {"/deletereq"})
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!RoleChecker.isMentee(u)) {
            ...
            try {
                ...
                rd.deleteRequestskill(reqId);
                rd.deleteRequest(reqId);
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("ListRequest.jsp");
