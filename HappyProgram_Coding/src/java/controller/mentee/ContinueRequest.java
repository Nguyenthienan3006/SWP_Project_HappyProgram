 ...
 * @author admin
 */
public class ContinueRequest extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ContinueRequest</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ContinueRequest at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!RoleChecker.isMentee(user)) {
            ...
            if (check == 0) {
                request.setAttribute("mess", "Continue success full!");
                request.getRequestDispatcher("listrequest").forward(request, response);
            } else {
                request.setAttribute("mess", "Continue fail!");
                request.getRequestDispatcher("listrequest").forward(request, response);
            }
        }
    }
