 ...
 * @author An Nguyen
 */
@WebServlet(name = "UpdateRequestServlet", urlPatterns = {"/updatereq"})
public class UpdateRequestServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!RoleChecker.isMentee(user)) {
            ...
            try {
                ...
                RequestDispatcher dispatcher = request.getRequestDispatcher("update_request.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        d.updateRequest(menteeID, mentorID, 1, createdDate, finishDate, Date_hour, Request_hour, Title_of_request, Desciption_of_request, reqId);

        d.deleteRequestskill(reqId);
